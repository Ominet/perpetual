...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'variantproducts.custom_category_search_provider' => 'getVariantproducts_CustomCategorySearchProviderService.php',
        ];
        $this->privates = [
            'csa_guzzle.default_cache_adapter' => true,
            'monolog.handler.legacy' => true,
            'prestashop.bundle.routing.converter.cache' => true,
            'prestashop.core.product.search.category_search_provider' => true,
        ...
        $this->aliases = [
            ...
            'prestashop.core.product.search.category_search_provider' => 'variantproducts.custom_category_search_provider',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('GKkkK48vJz', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'perpetual', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_69a754cc97739ea5dcd3ac0f27ad05ef4e3980b083fba23ccbcc342b6297b244');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('VO9IcrEewxThWc6pULQcj3bG8gj3BaOtWUmPhiQTz1tL0gLCfwjr045x'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('VO9IcrEewxThWc6pULQcj3bG8gj3BaOtWUmPhiQTz1tL0gLCfwjr045x');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'VO9IcrEewxThWc6pULQcj3bG8gj3BaOtWUmPhiQTz1tL0gLCfwjr045x',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2025-07-08',
            'locale' => 'fr-FR',
            'cookie_key' => 'jOYa8gKGOJE2ziwQ2GhvtUhXL2I34MMKqJsK56ciqg5KOIC481peeJjW',
            'cookie_iv' => 'sq23d4BI',
            'new_cookie_key' => 'def0000034766b3da5cf19e549d9fb1528703ff7e3df54a1884bb5b977ef5feb64f6178eb6f76e58d4b74c72faf4e61d8d5d6d05dedd364c3c670c18957cb5828bb6fc6e',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'VO9IcrEewxThWc6pULQcj3bG8gj3BaOtWUmPhiQTz1tL0gLCfwjr045x',
